...
ParameterPool::ParameterPool() {
	for(int i = 0; i < NUMBER_OF_VOICES; i++) {
		store(p_ADSR1_Attack, i, "amp_attack", 2200.0);
		store(p_ADSR1_Decay, i, "amp_decay", 2200.0);
		store(p_ADSR1_Sustain, i, "amp_sustain", 1.0);
		store(p_ADSR1_Release, i, "amp_release", 2200.0);

		store(p_ADSR2_Attack, i, "mod_attack", 2200.0);
		store(p_ADSR2_Decay, i, "mod_decay", 2200.0);
		store(p_ADSR2_Sustain, i, "mod_sustain", 1.0);
		store(p_ADSR2_Release, i, "mod_release", 2200.0);
		...
		store(p_WT1_Amount, i, "wt1_amount", 1.0);
		store(p_WT2_Amount, i, "wt2_amount", 1.0);
		store(p_WT_Shape, i, "wt_shape", 1.0);
		
		store(p_WS1_Amount, i, "ws1_amount", 1.0);
		store(p_WS2_Amount, i, "ws2_amount", 1.0);
		...
		store(p_KS_Amount, i, "ks_amount", 1.0);
		...
		store(p_VoiceMaster, i, "voice_master", 1.0);
	}
